...
constructor for \mbox{\hyperlink{classEmployee}{Employee}} class

\begin{DoxyPrecond}{Precondition}
n/a 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
makes \mbox{\hyperlink{classEmployee}{Employee}} object with varibles 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
makes employee object with values for varibles 
\end{DoxyPostcond}
...
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
1 is added to the employees year(s) of employment and rate is changed 
\end{DoxyPostcond}
...
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
returns pay based on the rate and hours worked 
\end{DoxyPostcond}
